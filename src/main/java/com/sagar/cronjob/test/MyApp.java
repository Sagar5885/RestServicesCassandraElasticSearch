...
public class MyApp {
	...
	public static void main(String args[]) {
		try {
			...
			//Job3
			JobDetail job3 = JobBuilder.newJob(Job3.class).withIdentity("job3", "group3").build();
			...
			//Job4
			JobDetail job4 = JobBuilder.newJob(Job4.class).withIdentity("job4", "group4").build();
			...
			//Job4
			JobDetail job5 = JobBuilder.newJob(Job5.class).withIdentity("job5", "group5").build();
